 ...
 *
 * Authoring contract for bit.riv (see bit-rive-guide.md):
 *   - state machine named "Bit"
 *   - a Number input named "state" with these values:
 *       0 idle · 1 speaking · 2 thinking · 3 happy · 4 concerned · 5 celebrate
 */
